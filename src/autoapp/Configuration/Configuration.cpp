...
const std::string Configuration::cInputNightButtonKey = "Input.NightButton";
...
void Configuration::readButtonCodes(boost::property_tree::ptree& iniConfig)
{
    ...
    this->insertButtonCode(iniConfig, cInputNightButtonKey, aasdk::proto::enums::ButtonCode::NIGHT);
}
...
void Configuration::writeButtonCodes(boost::property_tree::ptree& iniConfig)
{
    ...
    iniConfig.put<bool>(cInputNightButtonKey, std::find(buttonCodes_.begin(), buttonCodes_.end(), aasdk::proto::enums::ButtonCode::NIGHT) != buttonCodes_.end());
}
